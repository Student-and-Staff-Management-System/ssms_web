...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'staffs.context_processors.staff_context',
            ],
        },
    },
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15), # Web Users (Short)
    'REFRESH_TOKEN_LIFETIME': timedelta(days=90),   # Mobile Users (Long)
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "students.StudentGenerator": "fas fa-magic",
        "staffs.Staff": "fas fa-chalkboard-teacher",
        "staffs.StaffGenerator": "fas fa-user-plus",
