...
urlpatterns = [
    ...
    path('profile/portfolio/designation/add/', views.portfolio_add_designation, name='portfolio_add_designation'),
    path('profile/portfolio/designation/<int:pk>/edit/', views.portfolio_edit_designation, name='portfolio_edit_designation'),
    ...
    path('subjects/<int:subject_id>/attendance/calendar/', views.attendance_calendar, name='attendance_calendar'),
    path('attendance/overall-calendar/', views.overall_attendance_calendar, name='overall_attendance_calendar'),
    ...
    path('admin-portal/', views.admin_portal_dashboard, name='admin_portal_login'),
    ...
    path('generate-staff/', views.generate_staff, name='generate_staff'),
