...
urlpatterns = [
   ...
   # path('reset-password-request/', views.password_reset_request, name='password_reset_request'),
    ...
    path('scholar/phd-tracker/', scholars_views.scholar_phd_tracker, name='scholar_phd_tracker'),
    ...
    path('scholar/phd/upload-docs/', scholars_views.scholar_upload_stage_docs, name='scholar_upload_stage_docs'),
